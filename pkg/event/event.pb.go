...
const file_pkg_event_event_proto_rawDesc = "" +
	"\n" +
	"\x15pkg/event/event.proto\x12\x05event\x1a\x1fgoogle/protobuf/timestamp.proto\"\x88\x02\n" +
	"\x05Event\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x03R\x06offset\x12\x14\n" +
	"\x05topic\x18\x02 \x01(\tR\x05topic\x12\x10\n" +
	"\x03key\x18\x03 \x01(\fR\x03key\x12\x14\n" +
	"\x05value\x18\x04 \x01(\fR\x05value\x128\n" +
	"\ttimestamp\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x123\n" +
	"\aheaders\x18\x06 \x03(\v2\x19.event.Event.HeadersEntryR\aheaders\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B1Z/github.com/shankalpaLamichhane/corvus/pkg/eventb\x06proto3"
